    ...
    <div class="slider-area pos-relative">
        <div class="slider-active">
            <div class="single-slider slider-height d-flex align-items-center justify-content-center" style="background-image: url(assets/img/slider/slider_bg_1.jpg);">
                <div class="container">
                    <div class="row">
            ...
            <div class="single-slider slider-height d-flex align-items-center justify-content-center" style="background-image: url(assets/img/slider/2.jpg);">
                <div class="container">
                    <div class="row">
            ...
            <div class="single-slider slider-height d-flex align-items-center justify-content-center" style="background-image: url(assets/img/slider/3.jpg);">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-9 col-md-12">
                            <div class="slider-content slider-content-2">
            ...
            <div class="row">
                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about-right-img mb-30">
                        <img src="{{asset('assets/img/about/about-right.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="row pt-65">
            ...
            <div class="courses-list">
                <div class="row courses-active">
                    <div class="col-xl-12">
                        <div class="courses-wrapper course-radius-none mb-30">
                            <div class="courses-thumb">
                                <a href="course_details.html"><img src="{{asset('assets/img/courses/single_courses_thumb_01.jpg')}}" alt=""></a>
                            </div>
                            <div class="courses-author">
                                <img src="{{asset('assets/img/courses/coursesauthor1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="courses-wrapper course-radius-none mb-30">
                            <div class="courses-thumb">
                                <a href="course_details.html"><img src="{{asset('assets/img/courses/single_courses_thumb_02.jpg')}}" /></a>
                            </div>
                            <div class="courses-author">
                                <img src="{{asset('assets/img/courses/coursesauthor1.png')}}" />
                            </div>
                            <div class="course-main-content clearfix">
                                <div class="courses-content">
                                    <div class="courses-category-name">
                    ...
                    <div class="col-xl-12">
                        <div class="courses-wrapper course-radius-none mb-30">
                            <div class="courses-thumb">
                                <a href="course_details.html"><img src="{{asset('assets/img/courses/single_courses_thumb_03.jpg')}}" /></a>
                            </div>
                            <div class="courses-author">
                                <img src="{{asset('assets/img/courses/coursesauthor1.png')}}" alt="">
                            </div>
                    ...
                    <div class="col-xl-12">
                        <div class="courses-wrapper course-radius-none mb-30">
                            <div class="courses-thumb">
                                <a href="course_details.html"><img src="{{asset('assets/img/courses/single_courses_thumb_04.jpg')}}" alt=""></a>
                            </div>
                            <div class="courses-author">
                                <img src="{{asset('assets/img/courses/coursesauthor1.png')}}" alt="">
                            </div>
            ...
            <div class="team-list">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{asset('assets/img/team/teammember1.jpg')}}" alt="">
                            </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{asset('assets/img/team/teammember2.jpg')}}" alt="">
                            </div>
                            <div class="team-social-info text-center">
                                <div class="team-social-para">
                                    <p>Belis nisl adipiscing sapien malesu diame lacus eget erats</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{asset('assets/img/team/teammember3.jpg')}}" alt="">
                            </div>
                            <div class="team-social-info text-center">
                                <div class="team-social-para">
                                    <p>Belis nisl adipiscing sapien malesu diame lacus eget erats</p>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6">
                        <div class="team-wrapper mb-30">
                            <div class="team-thumb">
                                <img src="{{asset('assets/img/team/teammember4.jpg')}}" alt="">
                            </div>
                            <div class="team-social-info text-center">
                                <div class="team-social-para">
                                    <p>Belis nisl adipiscing sapien malesu diame lacus eget erats</p>
    ...
    <!-- events start -->
    <div id="events" class="events-area events-bg-height pt-100 pb-95" style="background-image: url(assets/img/courses/courses_bg.png);">
        <div class="container">
            <div class="row">
                <div class="col-xl-6 offset-xl-3 col-lg-8 offset-lg-2 col-md-10 offset-md-1">
                    <div class="section-title mb-50 text-center">
                    ...
                    <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="events-wrapper">
                                <div class="events-inner d-flex">
                                    <div class="events-thumb">
                                        <img src="{{asset('assets/img/events/eventsthumb1.png')}}" alt="">
                                    </div>
                        ...
                        <div class="single-events mb-30">
                            <div class="events-wrapper">
                                <div class="events-inner d-flex">
                                    <div class="events-thumb">
                                        <img src="{{asset('assets/img/events/eventsthumb2.png')}}" alt="">
                                    </div>
                                    <div class="events-text white-bg">
                                        <div class="event-text-heading mb-20">
                                            <div class="events-calendar text-center f-left">
                    ...
                    <div class="col-xl-6 col-lg-6">
                        <div class="single-events mb-30">
                            <div class="events-wrapper">
                                <div class="events-inner d-flex">
                                    <div class="events-thumb">
                                        <img src="{{asset('assets/img/events/eventsthumb3.png')}}" alt="">
                                    </div>
                                    <div class="events-text white-bg">
                                        <div class="event-text-heading mb-20">
                                            <div class="events-calendar text-center f-left">
                        ...
                        <div class="single-events mb-30">
                            <div class="events-wrapper">
                                <div class="events-inner d-flex">
                                    <div class="events-thumb">
                                        <img src="{{asset('assets/img/events/eventsthumb4.png')}}" alt="">
                                    </div>
                                    <div class="events-text white-bg">
                                        <div class="event-text-heading mb-20">
                                            <div class="events-calendar text-center f-left">
                ...
                <div class="row testimonilas-active">
                        ...
                        <div class="testimonilas-wrapper mb-110">
                            <div class="testimonilas-heading d-flex">
                                <div class="testimonilas-author-thumb">
                                    <img src="{{asset('assets/img/testimonials/testimonilas_author_thumb1.png')}}" alt="">
                                </div>
                    ...
                    <div class="col-xl-12">
                        <div class="testimonilas-wrapper">
                            <div class="testimonilas-heading d-flex">
                                <div class="testimonilas-author-thumb">
                                    <img src="{{asset('assets/img/testimonials/testimonilas_author_thumb2.png')}}" alt="">
                                </div>
                                <div class="testimonilas-author-title">
                ...
                <div class="col-xl-12">
                    <div class="video-wrapper text-center">
                        <div class="video-content">
                            <a class="popup-video" href="https://www.youtube.com/watch?v=i8nLrvcNcrg"><img src="{{asset('assets/img/video/play_icon.png')}}" alt=""></a>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="blog-wrapper mb-30">
                        <div class="blog-thumb mb-25">
                            <a href="news_details.html"><img src="{{asset('assets/img/blog/blog_thumb_1.jpg')}}" alt=""></a>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="blog-wrapper mb-30">
                        <div class="blog-thumb mb-25">
                            <a href="news_details.html"><img src="{{asset('assets/img/blog/blog_thumb_2.jpg')}}" alt=""></a>
                            <span class="blog-category">news</span>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6">
                    <div class="blog-wrapper mb-30">
                        <div class="blog-thumb mb-25">
                            <a href="news_details.html"><img src="{{asset('assets/img/blog/blog_thumb_3.jpg')}}" alt=""></a>
                            <span class="blog-category">news</span>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="brand-list">
                        <ul>
                            <li><img src="{{asset('assets/img/brand/brand1.png')}}" alt=""></li>
                            <li><img src="{{asset('assets/img/brand/brand2.png')}}" alt=""></li>
                            <li><img src="{{asset('assets/img/brand/brand3.png')}}" alt=""></li>
                            <li><img src="{{asset('assets/img/brand/brand4.png')}}" alt=""></li>
                            <li><img src="{{asset('assets/img/brand/brand5.png')}}" alt=""></li>
                            <li><img src="{{asset('assets/img/brand/brand6.png')}}" alt=""></li>
                        </ul>
                    </div>
                </div>
            </div>
